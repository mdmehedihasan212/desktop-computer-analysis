        ...
        <section>
            <div className="product-container">
                ...
                <div className="product-details">
                    ...
                    <button className='px-6 py-2 rounded bg-blue-600 text-white' to={'/'}>Details</button>
                </div>
            </div>
            <div className="review-container">
                ...
                <div className="review-btn text-center m-6">
                    <Link to={'/review'} className='px-32 py-1 rounded-lg bg-blue-600 text-white'>See All Reviews</Link>
                </div>
            </div>
        </section>
    );
